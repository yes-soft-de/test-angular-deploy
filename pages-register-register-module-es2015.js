...
/* harmony import */ var _store_auth_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../store/auth.actions */ "./src/app/pages/register/store/auth.actions.ts");
/* harmony import */ var _store_auth_selector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../store/auth.selector */ "./src/app/pages/register/store/auth.selector.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/__ivy_ngcc__/fesm2015/forms.js");
/* harmony import */ var src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/@theme/store/shared/shared.actions */ "./src/app/@theme/store/shared/shared.actions.ts");
...
class LoginComponent {
    ...
    ngOnInit() {
        ...
        // Get Error Messages
        this.store.select(_store_auth_selector__WEBPACK_IMPORTED_MODULE_2__["getErrorAuth"]).subscribe(error => {
            this.process = false;
            this.error = error;
        });
    }
    onSubmit() {
        this.process = true;
        // Form Code
        this.store.dispatch(Object(src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_4__["setLoadSpinner"])({ status: true }));
        this.store.dispatch(Object(_store_auth_actions__WEBPACK_IMPORTED_MODULE_1__["startLogin"])({ data: this.loginForm.getRawValue() }));
    }
}
LoginComponent.ɵfac = function LoginComponent_Factory(t) { return new (t || LoginComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_ngrx_store__WEBPACK_IMPORTED_MODULE_5__["Store"])); };
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 28, vars: 9, consts: [[1, "col-12", "col-sm-11", "col-md-9", "col-lg-7", "col-xl-7", "mx-auto", "my-5"], [1, "text-center", "text-muted", "mb-3"], [1, "card"], [1, "cord-header"], [1, "card-body"], [1, "alert", "alert-danger", "mb-0", "my-2", 3, "hidden"], [3, "formGroup", "ngSubmit"], [1, "form-group", "row"], ["for", "inputEmail3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], [1, "col-12", "col-sm-10", "col-md-9", "col-lg-10", "col-xl-10"], ["type", "text", "name", "username", "formControlName", "username", "id", "inputEmail3", "placeholder", "Username", "required", "", 1, "form-control"], [1, "alert", "alert-danger", "mb-0", "mt-2", 3, "hidden"], ["for", "inputPassword3", 1, "col-12", "col-sm-2", "col-md-3", "col-lg-2", "col-xl-2", "col-form-label"], ["type", "password", "name", "password", "formControlName", "password", "id", "inputPassword3", "placeholder", "Password", "required", "", 1, "form-control"], [1, "col-12"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], ["class", "text-success m-2", 4, "ngIf"], [1, "text-success", "m-2"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
...
/* harmony import */ var _store_auth_effects__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./store/auth.effects */ "./src/app/pages/register/store/auth.effects.ts");
...
RegisterModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({ factory: function RegisterModule_Factory(t) { return new (t || RegisterModule)(); }, providers: [_service_register_service__WEBPACK_IMPORTED_MODULE_5__["RegisterService"]], imports: [[
            ...
            _ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["EffectsModule"].forFeature([_store_auth_effects__WEBPACK_IMPORTED_MODULE_7__["AuthEffects"]])
        ]] });
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](RegisterModule, { declarations: [_components_login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"],
        ...
        _register_routing_module__WEBPACK_IMPORTED_MODULE_2__["RegisterRoutingModule"], _ngrx_effects__WEBPACK_IMPORTED_MODULE_6__["EffectsFeatureModule"]] }); })();
...
/* harmony import */ var src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/@theme/store/shared/shared.actions */ "./src/app/@theme/store/shared/shared.actions.ts");
/* harmony import */ var _auth_actions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./auth.actions */ "./src/app/pages/register/store/auth.actions.ts");
...
/* harmony import */ var _service_register_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../service/register.service */ "./src/app/pages/register/service/register.service.ts");
/* harmony import */ var src_app_theme_admin_service_auth_auth_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! src/app/@theme/admin-service/auth/auth.service */ "./src/app/@theme/admin-service/auth/auth.service.ts");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/__ivy_ngcc__/fesm2015/router.js");
/* harmony import */ var src_app_theme_admin_service_token_token_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/@theme/admin-service/token/token.service */ "./src/app/@theme/admin-service/token/token.service.ts");
...
class AuthEffects {
    constructor(actions$, store, registerService, authService, router, activatedRouter, tokenService) {
        ...
        this.startLogin$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_5__["startLogin"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["exhaustMap"])(action => this.registerService.login(action.data)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => {
            this.tokenService.handle(action.data.username, response.token);
            this.authService.changeAuthStatus(true);
            this.store.dispatch(Object(src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_4__["setLoadSpinner"])({ status: false }));
            ...
            this.store.dispatch(Object(src_app_theme_store_shared_shared_actions__WEBPACK_IMPORTED_MODULE_4__["setLoadSpinner"])({ status: false }));
            return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["of"])(_auth_actions__WEBPACK_IMPORTED_MODULE_5__["failureLogin"]({ error: errorMessage }));
        })))));
        // Redirect After Success Login
        this.loginRedirect$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["createEffect"])(() => this.actions$.pipe(Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["ofType"])(_auth_actions__WEBPACK_IMPORTED_MODULE_5__["successLogin"]), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["tap"])(res => this.router.navigate(['../'], { relativeTo: this.activatedRouter }))), { dispatch: false });
    }
}
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AuthEffects, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"]
    }], function () { return [{ type: _ngrx_effects__WEBPACK_IMPORTED_MODULE_1__["Actions"] }, { type: _ngrx_store__WEBPACK_IMPORTED_MODULE_6__["Store"] }, { type: _service_register_service__WEBPACK_IMPORTED_MODULE_7__["RegisterService"] }, { type: src_app_theme_admin_service_auth_auth_service__WEBPACK_IMPORTED_MODULE_8__["AuthService"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"] }, { type: _angular_router__WEBPACK_IMPORTED_MODULE_9__["ActivatedRoute"] }, { type: src_app_theme_admin_service_token_token_service__WEBPACK_IMPORTED_MODULE_10__["TokenService"] }]; }, null); })();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getErrorAuth", function() { return getErrorAuth; });
/* harmony import */ var _ngrx_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ngrx/store */ "./node_modules/@ngrx/store/__ivy_ngcc__/fesm2015/store.js");
/* harmony import */ var _auth_reducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./auth.reducer */ "./src/app/pages/register/store/auth.reducer.ts");


const authFeatureState = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createFeatureSelector"])(_auth_reducer__WEBPACK_IMPORTED_MODULE_1__["authsFeatureKey"]);
const getErrorAuth = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_0__["createSelector"])(authFeatureState, state => state.error);
